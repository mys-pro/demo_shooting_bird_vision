...
class birds(pygame.sprite.Sprite):
    def __init__(self, x, y, folder_name, speed, frame_rate):
        ...
        self.image_copy = self.image.copy()
        self.image_smaller = pygame.transform.scale(self.image_copy, (self.image_copy.get_width() // 2, self.image_copy.get_height() // 2))
        self.rect_smaller = self.image_smaller.get_rect()
        self.rect_smaller.center = (x + self.image.get_width() // 2, self.image.get_height() // 2)
        ...
        self.rect = pygame.Rect(self.rect.x, self.rect.y, self.rect.width // 2, self.rect.height // 2)
