...
def draw(SCREEN, background, view_finder, clickable_square):
    ...
    if clickable_square and clickable_square.visible:
...
def main(SCREEN):
    ...
    clickable_square = ClickableSquare()
    running = True
    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT or (event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE):
                ...
                if clickable_square and clickable_square.is_clicked():
                    clickable_square.toggle_visibility()
