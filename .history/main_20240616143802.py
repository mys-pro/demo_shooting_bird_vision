...
def draw(SCREEN, background, bg_x, bg_y):
...
def main(SCREEN):
    ...
    while running:
        ...
        # Cập nhật vị trí của viewfinder theo chuột
        view_finder.follow_mouse()

        # Vẽ viewfinder lên màn hình
        SCREEN.blit(view_finder.image, view_finder.rect.topleft)
