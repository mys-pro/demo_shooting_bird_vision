...
def main():
    ...
    cursor_img = pygame.image.load('assets/images/viewfinder.png').convert_alpha() # Tải hình ảnh con trỏ chuột
    ...
    bg, bg_x, bg_y = load_background('assets/images/backgrounds/', WIDTH, HEIGHT) # Gọi hàm load_random_background
    ...
    while running:
        ...
        SCREEN.blit(pygame.image.load('assets/images/birds/bird1/b-1.png'), (50, 50)) # Vẽ hình nền lên màn hình
        SCREEN.blit(pygame.image.load('assets/images/birds/bird1/b-1.png'), (60, 70)) # Vẽ hình nền lên màn hình
