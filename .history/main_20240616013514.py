...
def main():
    ...
    cursor_img = pygame.image.load(r'assets').convert_alpha() # Tải hình ảnh con trỏ chuột
    pygame.mouse.set_cursor(*pygame.cursors.arrow, hotspot=(0, 0), xormasks=(cursor_img, cursor_img))
