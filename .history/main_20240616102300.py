...
def main():
    ...
    bg = pygame.image.load("assets/images/backgrounds/Cartoon_Forest_BG_01.png", size=(SCREEN_WIDTH, SCREEN_HEIGHT), convert="default")
    ...
    while running:
        ...
        SCREEN.pygame.sprite.draw(surface, bgd=None)
