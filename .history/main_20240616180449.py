...
class birds:
    def __init__(self, x, y, folder_name, speed, frame_rate):
        ...
        self.image_copy = self.image.copy()
        self.image_smaller = pygame.transform.scale(self.image_copy, (self.image_copy.get_width() - 20, self.image_copy.get_height() - 20))
        self.rect = self.image_smaller.get_rect()
        self.rect.center = (self.image.get_width() // 2, SCREEN_HEIGHT // 2)
        self.rect.x = x
        self.rect.y = y
        self.speed = speed
