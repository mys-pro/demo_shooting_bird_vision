...
def main(SCREEN):
    finder = pygame.image.load('assets/images/viewfinder.png') # Tải hình ảnh kính ngắm
    finder_rect = finder.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2))
    finder_width, finder_height = finder.get_size()
    ...
    while running:
        ...
        SCREEN.blit(finder, (mouse_x - (finder_width // 2), mouse_y - (finder_height // 2))) # Vẽ ảnh ảnh lên vị trí con trỏ
