...
class birds:
    def __init__(self, x, y, folder_name, speed, frame_rate):
        ...
        self.image_copy = self.image.copy()
        self.image_smaller = pygame.transform.scale(self.image_copy, (self.image_copy.get_width() - 30, self.image_copy.get_height() - 30))
        self.rect = self.image_smaller.get_rect()
        self.rect.center = (self.image.get_width(), y // 2)
        # self.rect.x = x
        # self.rect.y = y
        self.speed = speed
